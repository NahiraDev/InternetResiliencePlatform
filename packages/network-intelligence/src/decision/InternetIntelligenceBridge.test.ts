...
const context: NetworkDecisionContextWithInternetEvidence = {
  ...
  internetEvidence: {
    timestamp: '2026-08-29T19:00:00.000Z', latencyMs: 80, jitterMs: 4, packetLossRatio: 0.01,
    dnsLookupMs: 30, httpResponseMs: 100, httpsHandshakeMs: 40, ipv4Connectivity: true,
    ipv6Connectivity: false, gatewayReachable: true, internetReachable: true, qualityScore: 90,
  },
  candidates: [],
};

const recommendation = {
  diagnosis: 'healthy', kind: 'observe', confidence: 0.95, rationale: 'Measured evidence is healthy.',
  evidence: ['reachability-ok'], generatedBy: 'deterministic' as const, createdAt: '2026-08-29T19:00:00.000Z',
};
